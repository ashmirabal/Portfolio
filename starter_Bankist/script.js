...
// Guard clause
//if nothing clicked, immediately finish this function
  if(!clicked) return;
...
// Sticky navigation: Intersection Observer API (better way to do sticky nav)
...
// const obsOptions = {
//   root: null,
//   threshold: [0, 0.2], //cb function will get called at 10%
// };
...
const revealSection = function(entries, observer) {
  ...
  observer.unobserve(entry.target) //stops observer function and enhances performance
};
...
const alertH1 = function(e){
  ...
  // h1.removeEventListener('mouseenter', alertH1) // so that we can only listen to the event once
};
